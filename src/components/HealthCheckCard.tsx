...
const HealthCheckCard = ({
  ...
  if (check) {
    return <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-900/30 space-y-6 animate-scale-in">
        <div className="flex justify-between items-center border-b dark:border-gray-700 pb-4">
          <div className="flex items-center gap-4">
            ...
            <Button variant="ghost" size="icon" onClick={() => onDelete?.(check.id)} className="text-destructive hover:text-destructive hover:bg-destructive/10 dark:text-destructive dark:hover:bg-destructive/20">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {check.why && <div className="space-y-2">
  ...
  return <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-gray-900/30 space-y-4 border-2">
      <div className="space-y-2">
      ...
      <div className="space-y-4">
        <Progress value={localValue} className="w-full cursor-pointer hover:bg-secondary/80 dark:hover:bg-gray-700 transition-colors" onClick={handleProgressClick} />
